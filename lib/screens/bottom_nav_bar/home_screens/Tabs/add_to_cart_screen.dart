  ...
  Widget build(BuildContext context) {
    return SafeArea(child: Scaffold(
      appBar: AppBar(
        ...
        title:  Text('Cart',style: AppTextStyles.semiBoldStyle.copyWith(color: AppColors.mainBold,fontSize: 15),),
          actions: [
        ...
        child: SingleChildScrollView(
          ...
          children: [
            Row(
              ...
              Text('Delivered by Fragaa ',style: AppTextStyles.semiBoldStyle.copyWith(color: AppColors.blueColor,fontSize: 14),),
              const Spacer(),
              SvgPicture.asset('assets/images/product_description/Vector.svg'),
            ...
            Row(
              crossAxisAlignment: CrossAxisAlignment.center,mainAxisAlignment: MainAxisAlignment.start,children: [
                const Image(image: AssetImage("assets/images/product_description/m.png")),
              Expanded(
                child: Column(
                  crossAxisAlignment:
            ...
            const SizedBox(height: 10,),
            const Divider(thickness: 1,height: 1,color: Color(0xFFC2C2C2),)
            ,
            const SizedBox(height: 10,),
            Row(
              crossAxisAlignment: CrossAxisAlignment.center,mainAxisAlignment: MainAxisAlignment.start,children: [
              const Image(image: AssetImage("assets/images/product_description/o.png")),
              Expanded(
                child: Column(
                  crossAxisAlignment:
                  CrossAxisAlignment.start,mainAxisAlignment: MainAxisAlignment.start,children: [
                    ...
                    Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          const Spacer(),
                          Text('${value1}',style: AppTextStyles.mediumStyle.copyWith(color:const Color(0xff484848),fontSize: 11),),
                          const Spacer(),
                          const VerticalDivider(
                            thickness: 1,width: 1,color: Color(0xFFA6A8B7),
                          ),
            ...
            Row(
              crossAxisAlignment: CrossAxisAlignment.center,mainAxisAlignment: MainAxisAlignment.start,children: [
              Text('Delivered by Iceland ',style: AppTextStyles.semiBoldStyle.copyWith(color: AppColors.blueColor,fontSize: 14),),
              const Spacer(),
              SvgPicture.asset('assets/images/product_description/Vector.svg'),
              const SizedBox(width: 10,),
              const Text.rich(
            ...
            Row(
              crossAxisAlignment: CrossAxisAlignment.center,mainAxisAlignment: MainAxisAlignment.start,children: [
              const Image(image: AssetImage("assets/images/product_description/s.png")),
              Expanded(
                child: Column(
                  crossAxisAlignment:
                  CrossAxisAlignment.start,mainAxisAlignment: MainAxisAlignment.start,children: [
                    ...
                    Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          const Spacer(),
                          Text('${value2}',style: AppTextStyles.mediumStyle.copyWith(color:const Color(0xff484848),fontSize: 11),),
                          const Spacer(),
                          const VerticalDivider(
                            thickness: 1,width: 1,color: Color(0xFFA6A8B7),
                          ),
